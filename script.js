...
function mostrarInfo(tipo) {
    const conteudos = {
        ...
        irrigacao: ['💦 Irrigação Inteligente','A irrigação inteligente utiliza sensores e dados climáticos para fornecer água na quantidade certa. Isso reduz desperdícios, melhora o crescimento das plantas e aumenta a produtividade.'],
        fertilidade: ['🌾 Fertilidade do Solo','Manter a fertilidade do solo é essencial para boas colheitas. O uso correto de nutrientes, matéria orgânica e rotação de culturas ajuda a preservar a qualidade da terra.'],
        reflorestamento: ['🌳 Reflorestamento','O reflorestamento protege nascentes, reduz a erosão e contribui para o equilíbrio ambiental. Áreas reflorestadas ajudam a conservar a biodiversidade e melhorar o clima local.'],
        agriculturaDigital: ['📱 Agricultura Digital','A agricultura digital utiliza aplicativos, sensores e inteligência artificial para auxiliar o produtor na tomada de decisões mais rápidas e eficientes.'],
        cooperativas: ['🤝 Cooperativas Rurais','As cooperativas permitem que produtores rurais trabalhem juntos para obter melhores preços, acesso a tecnologias e oportunidades de comercialização.'],
